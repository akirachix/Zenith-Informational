  ...
  <div className="mb-6 font-serif">
    <div className="flex flex-wrap gap-6 sm:gap-16 md:gap-24 lg:gap-60 xl:gap- justify-center text-center">
        <div className="flex flex-col items-center mx-4">
            <img src="/images/Linet.png" alt="Linet Mkandoe" width={250} height={250} className="mb-4" />
            <h4 className="text-lg">Linet Mkandoe</h4>
        </div>
        <div className="flex flex-col items-center mx-4">
            <img src="/images/Aline.png" alt="Aline Mutesi" width={250} height={250} className="mb-4" />
    ...
    <div className="flex flex-wrap gap-8 sm:gap-16 md:gap-24 lg:gap-60 xl:gap justify-center text-center mt-6">
        <div className="flex flex-col items-center mx-4">
            <img src="/images/Nyabang.png" alt="Nyabang Wech" width={250} height={250} className="mb-4" />
            <h4 className="text-lg">Nyabang Wech</h4>
        </div>
        <div className="flex flex-col items-center mx-4">
            <img src="/images/DaisyC.png" alt="Daisy Chepkirui" width={250} height={250} className="mb-4" />
