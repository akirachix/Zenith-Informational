...
const Benefit = () => {
  ...
  <div className="flex flex-col md:flex-row gap-8 md:gap-16 px-4 sm:px-8 md:px-16 mt-8 md:mt-16 justify-center mx-auto">
    <div
      ...
      <p className="whitespace-normal text-base md:text-lg xl:text-xl xl:leading-loose">
    ...
    >
      ...
      <p className="whitespace-normal text-base md:text-lg xl:text-xl leading-loose">
  ...
  <p className="text-lg md:text-2xl leading-loose xl:text-xl mb-4">
  ...
  <p className="text-lg md:text-2xl leading-loose xl:text-xl">
