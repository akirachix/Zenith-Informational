...
const AboutUs = () => {
  ...
  <div className="flex flex-col items-center md:items-start w-4/5 md:w-1/2 text-center md:text-left">
    <p className="text-2xl sm:text-3xl md:text-2xl lg:text-4xl xl:text-[40px] font-bold">
      Transforming estates into resilient havens with AquaSense
    </p>
    <p className="text-lg sm:text-xl md:text-xl lg:text-3xl xl:text-[30px] mt-8">
      ...
      <div className="text-center mt-10 md:ml-6">
        <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-6xl xl:text-[70px] font-bold text-teal-700 mb-8">
          Product
        </h1>
        <div className="flex flex-col md:flex-row items-center justify-center gap- mt-10">
          <div className="flex flex-col items-center md:items-start w-4/5 md:w-1/2">
            <p className="text-lg sm:text-xl md:text-xl lg:text-3xl xl:text-[30px] text-center md:text-left">
